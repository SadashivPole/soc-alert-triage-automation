...
## 5. End-to-end with a disposable agent — **Phase 4.4 acceptance** (VERIFIED)
...
## 7. Secret / log hygiene (partially verified)
...
## 8. Idempotent duplicate delivery (REMAINS OUTSTANDING)
